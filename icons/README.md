...
- `manifest.webmanifest` lists raster icons only. `icon.svg` is linked from
  `index.html` as a favicon. Keeping it out of the manifest makes Chrome's
  primary install icon deterministic; it was not the cause of the Android
  shortcut regression (ADR 0008).
