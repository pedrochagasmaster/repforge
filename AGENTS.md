...
The `repforge_*` storage keys, IndexedDB name, notification tags, and `RepForge*` JavaScript globals/test hooks are compatibility identifiers from before the Taurifer rebrand. Do not rename them without an explicit data and API migration.
