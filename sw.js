const CACHE = "repforge-v281";
const ASSETS = [
  "./", "./index.html", "./styles.css", "./motion-polish.css", "./manifest.webmanifest",
  "./vendor/motion/motion.js", "./vendor/dnd-kit/dnd-kit.js", "./vendor/dnd-kit/dnd-kit.runtime.js", "./motion-layer.js", "./motion-layer.js?v=281",
  "./telemetry.js", "./posthog-init.js", "./schedule.js", "./notify.js", "./i18n.js", "./exercises.js", "./install-transfer-contract.js", "./install-transfer.js",
  "./progression-engine.js", "./progress-model.js", "./progress-model.js?v=281", "./program-compiler.js", "./program-compiler.js?v=281", "./program-entry.js", "./program-entry.js?v=281", "./program-entry-adapter.js", "./program-entry-adapter.js?v=281", "./program-editor.js", "./program-editor.js?v=281",
  "./shared-setup.js", "./shared-setup.js?v=281", "./workout-draft.js", "./workout-draft.js?v=281", "./program-transition.js", "./program-transition.js?v=281", "./install-policy.js", "./install-policy.js?v=281", "./guide-registry.js", "./guide-registry.js?v=281", "./durable-state.js", "./durable-state.js?v=281", "./app.js", "./app.js?v=281",
