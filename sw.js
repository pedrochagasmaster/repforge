const CACHE = "repforge-v299";
const ASSETS = [
  "./", "./index.html", "./styles.css", "./motion-polish.css", "./manifest.webmanifest",
  "./vendor/motion/motion.js", "./vendor/dnd-kit/dnd-kit.js", "./vendor/dnd-kit/dnd-kit.runtime.js", "./motion-layer.js", "./motion-layer.js?v=299",
  "./telemetry.js", "./posthog-init.js", "./schedule.js", "./notify.js", "./i18n.js", "./exercises.js", "./install-transfer-contract.js", "./install-transfer.js",
  "./progression-engine.js", "./progress-model.js", "./progress-model.js?v=299", "./program-compiler.js", "./program-compiler.js?v=299", "./program-entry.js", "./program-entry.js?v=299", "./program-entry-adapter.js", "./program-entry-adapter.js?v=299", "./program-editor.js", "./program-editor.js?v=299",
  "./shared-setup.js", "./shared-setup.js?v=299", "./workout-draft.js", "./workout-draft.js?v=299", "./program-transition.js", "./program-transition.js?v=299", "./install-policy.js", "./install-policy.js?v=299", "./guide-registry.js", "./guide-registry.js?v=299", "./durable-state.js", "./durable-state.js?v=299", "./history-ui.js", "./history-ui.js?v=299", "./app.js", "./app.js?v=299",
