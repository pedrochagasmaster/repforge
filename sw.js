const CACHE = "repforge-v193";
const ASSETS = [
  "./", "./index.html", "./styles.css", "./manifest.webmanifest",
  "./telemetry.js", "./posthog-init.js", "./schedule.js", "./notify.js", "./i18n.js", "./exercises.js",
  "./progression-engine.js", "./program-compiler.js", "./program-compiler.js?v=193", "./program-entry.js", "./program-entry.js?v=193", "./program-entry-adapter.js", "./program-entry-adapter.js?v=193", "./program-editor.js", "./program-editor.js?v=168",
  "./shared-setup.js", "./shared-setup.js?v=193", "./workout-draft.js", "./workout-draft.js?v=193", "./program-transition.js", "./program-transition.js?v=193", "./app.js", "./app.js?v=193",
...
const SHELL = new Set(["/", "/index.html", "/app.js", "/workout-draft.js", "/program-transition.js", "/styles.css", "/i18n.js", "/exercises.js", "/shared-setup.js", "/program-compiler.js", "/program-entry.js", "/program-entry-adapter.js", "/program-editor.js", "/telemetry.js", "/posthog-init.js", "/posthog-config.js", "/manifest.webmanifest"]);
