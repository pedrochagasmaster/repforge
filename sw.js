const CACHE = "repforge-v271";
const ASSETS = [
  "./", "./index.html", "./styles.css", "./motion-polish.css", "./manifest.webmanifest",
  "./vendor/motion/motion.js", "./vendor/dnd-kit/dnd-kit.js", "./vendor/dnd-kit/dnd-kit.runtime.js", "./motion-layer.js", "./motion-layer.js?v=271",
  "./telemetry.js", "./posthog-init.js", "./schedule.js", "./notify.js", "./i18n.js", "./exercises.js", "./install-transfer-contract.js", "./install-transfer.js",
  "./progression-engine.js", "./progress-model.js", "./progress-model.js?v=271", "./program-compiler.js", "./program-compiler.js?v=271", "./program-entry.js", "./program-entry.js?v=271", "./program-entry-adapter.js", "./program-entry-adapter.js?v=271", "./program-editor.js", "./program-editor.js?v=271",
  "./shared-setup.js", "./shared-setup.js?v=271", "./workout-draft.js", "./workout-draft.js?v=271", "./program-transition.js", "./program-transition.js?v=271", "./install-policy.js", "./install-policy.js?v=271", "./guide-registry.js", "./guide-registry.js?v=271", "./durable-state.js", "./durable-state.js?v=271", "./app.js", "./app.js?v=271",
