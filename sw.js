const CACHE = "repforge-v210";
const ASSETS = [
  "./", "./index.html", "./styles.css", "./motion-polish.css", "./manifest.webmanifest",
  "./vendor/motion/motion.js", "./vendor/dnd-kit/dnd-kit.js", "./vendor/dnd-kit/dnd-kit.runtime.js", "./motion-layer.js", "./motion-layer.js?v=210",
  "./telemetry.js", "./posthog-init.js", "./schedule.js", "./notify.js", "./i18n.js", "./exercises.js",
  "./progression-engine.js", "./program-compiler.js", "./program-compiler.js?v=210", "./program-entry.js", "./program-entry.js?v=210", "./program-entry-adapter.js", "./program-entry-adapter.js?v=210", "./program-editor.js", "./program-editor.js?v=210",
  "./shared-setup.js", "./shared-setup.js?v=210", "./workout-draft.js", "./workout-draft.js?v=210", "./program-transition.js", "./program-transition.js?v=210", "./app.js", "./app.js?v=210",
