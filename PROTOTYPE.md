...
The visual system uses weatherproof map colors—bone paper, spruce ink, safety orange, and cobalt—plus contour lines, trail blazes, elevation-style numerals, dashed survey rules, and compact field-map labels. It deliberately avoids editorial layouts, generic fitness neon, card grids, blur, and glass surfaces.
...
- Service-worker cache is bumped to `repforge-ascent-v14`.
