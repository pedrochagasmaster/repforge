...
260 frames. This folder is the visual reference for UI and Brand Designers.
...
| [Recommend — recommendation](screens/onboarding-recommend/result__phone-390-light-en.png) | 5 | One named recommendation with its factual Why it fits explanation. |
...
| [Custom 3 — real week](screens/onboarding-custom/schedule__phone-390-light-en.png) | 5 | Days per week, session ceiling and preferred rest in the custom route. |
...
| [Custom 5 — muscle priorities](screens/onboarding-custom/priorities__phone-390-light-en.png) | 5 | Each muscle has one accessible emphasis setting before exercise preferences. |
...
| [Build — empty days](screens/onboarding-build/editor-empty__phone-390-light-en.png) | 5 | Real empty day containers, Add exercise, Save draft, activation disabled. |
| [Build — partial draft](screens/onboarding-build/editor-partial__phone-390-light-en.png) | 5 | One populated day and one incomplete day. Activation stays disabled. |
| [Build — activation ready](screens/onboarding-build/editor-ready__phone-390-light-en.png) | 5 | A complete manual draft with supported progression and activation enabled. |
...
| [Import — review](screens/onboarding-import/preview__phone-390-light-en.png) | 5 | A mapped exercise with manual progression ownership and provenance. |

### Onboarding — Shared setup link

| Screen | Frames | What it shows |
| --- | --- | --- |
| [Shared setup — confirmation gate](screens/onboarding-shared/gate__phone-390-light-en.png) | 5 | The first-run gate for an incoming setup link. Nothing persists until Start. |
...
| [Progress — Review](screens/progress/review__phone-390-light-en.png) | 5 | The mesocycle review surface. |
...
| [History — expanded session](screens/history/session__phone-390-light-en.png) | 5 | One session expanded in place. |
...
| [Program — share setup link](screens/program/share-setup__phone-390-light-en.png) | 5 | The setup-link share sheet. |
