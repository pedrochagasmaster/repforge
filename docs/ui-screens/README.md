...
| --- | --- | --- |
| [One-time landing](screens/onboarding-start/first-run__phone-390-light-en.png) | 7 | First empty visit. Six product beats, early Build and Track actions, Privacy, and device-local seen state. |
