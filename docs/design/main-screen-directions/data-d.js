...
(function (root) {
  ...
  const NEW = {
    ...
    "d.freq.title": ["Frequência no bloco", "Frequency this block"],
    "d.freq.wk": ["S{n}", "W{n}"],
    "d.freq.count": ["{done} de {planned}", "{done} of {planned}"],
    "d.freq.total": ["{done} de {planned} sessões no bloco, semana {n} de {total}", "{done} of {planned} sessions this block, week {n} of {total}"],
    "d.freq.per_week": ["Por semana", "Per week"],
    "d.freq.per_weekday": ["Por dia da semana", "By weekday"],
