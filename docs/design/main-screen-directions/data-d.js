...
(function (root) {
  ...
  const NEW = {
    ...
    "d.why.evidence_many": ["Com base em {n} sessões comparáveis, a última em {date}", "Based on {n} comparable sessions, the latest on {date}"],
    ...
    "d.chart.table": ["Sessões", "Sessions"],
    "d.chart.increase": ["carga subiu", "load went up"],
    ...
    "d.history.cal_title": ["Setembro de 2026", "September 2026"],
    ...
    "d.first.lede": ["{date}, semana 1", "{date}, week 1"],
  };
