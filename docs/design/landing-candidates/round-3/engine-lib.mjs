// Shared helpers for the round-3 engine scripts. Each script runs Taurifer's
...
//
//   node docs/design/landing-candidates/round-3/<script>.mjs           # print
//   node docs/design/landing-candidates/round-3/<script>.mjs --check   # verify index.html
//   node docs/design/landing-candidates/round-3/<script>.mjs --write   # update index.html
...
// The settings every round-3 example uses: 2.5 kg plates, a 2.5% jump and the
