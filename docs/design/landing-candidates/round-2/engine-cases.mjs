// The three verified cases candidate S (and V's worked example) show:
// range@1, 3 working sets, one logged session as history, week 1 of 6.
// Each case asserts the result the brief verified, so a future engine change
// that moves any of these numbers fails loudly instead of drifting the page.
