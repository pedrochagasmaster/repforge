# Plan 022: Beginner literacy — plain program variant + effort-based RIR
...
- **Depends on**: none (plan 002 glossary DONE — extend, don't duplicate;
  plan 017 program JSON export is a convenient delivery format but not blocking)
- **Category**: direction
...
- Substitution alternates (plan 021) should use plain names in beginner variant
- Coach templates (backlog) can ship JSON of `programBeginner` via plan 017 export
- Beginner program file format is plan 017's program JSON — keep stable
