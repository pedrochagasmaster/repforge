...
| [047](./047-taurifer-program-families-compiler.md) | **READY — 3 OF 4** | Authors the initial original Taurifer families and compiles their 3-/5-day siblings plus reviewed 2-/6-day recipes through the shared engine. Current-tense guidance stands except where G-01–G-88 supersede it (see the disposition register); Plans 052/056 own transition and recovery derivation from compiler output. |
| [048](./048-program-entry-onboarding-redesign.md) | **READY — 4 OF 4** | Separates Recommend, Generate custom, Browse, Build, and Import, then converges them on one resumable draft/preview/activation path. Current-tense flow stands except where G decisions supersede it — merged recommendation result/preview (G-79), adaptive landing (G-37), install timing (G-39/G-48/G-72), and contextual guides (G-40) are specified by Plans 053–054; see the disposition register. |
