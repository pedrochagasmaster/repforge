...
| Plan | State | Meaning |
|---|---|---|
| [063](./063-direction-d-redesign.md) | **PROPOSED — AFTER 058, BEFORE 059** | Builds the owner-selected Direction D on Plan 058's roles: Today, Focus and the workout shelf, inline rest, Why this weight, the session summary, Progress and the chart, History, Program. Specified in `docs/design/direction-d-implementation-spec.md`; decided in ADR 0016. |
