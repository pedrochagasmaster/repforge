export const ALPHA_EVENT_NAMES = Object.freeze([
  ...
  "program_import_handoff",
  "program_import_parsed",
  "program_import_unsupported_concept",
  "program_import_review_reached",
  "program_import_row_resolved",
  "program_activated",
  "first_set_logged",
  "set_saved",
...
export const VALID_ALPHA_EVENTS = Object.freeze([
  ...
  ["program_import_started", { source: "freeform" }],
  ["program_import_handoff", { method: "chatgpt", outcome: "opened", long_prompt: false }],
  ["program_import_parsed", { source: "freeform", outcome: "complete", gap_count: 0 }],
  ["program_import_unsupported_concept", { category: "supersets" }],
  ["program_import_review_reached", { source: "freeform" }],
  ["program_import_row_resolved", { method: "top_candidate", source: "freeform" }],
...
export const INVALID_EVENTS = Object.freeze([
  ...
  ["program_import_unsupported_concept", { category: "unknown_user_text" }],
  ["program_import_unsupported_concept", { category: "tempo", free_text: "private" }],
...
export const EVENT_DUPLICATE_POLICIES = Object.freeze({
  ...
  program_import_started: "repeatable",
  program_import_handoff: "repeatable",
  program_import_parsed: "repeatable",
  program_import_unsupported_concept: "repeatable",
  program_import_review_reached: "repeatable",
  program_import_row_resolved: "repeatable",
