...
export const SUITES = {
  fast: [
    ...
    s("test/session-intent.mjs", [], { domains: ["workout", "history", "progress"] }),
    s("test/session-planner.mjs", [], { domains: ["workout"] }),
    s("test/one-off-session.mjs", [], { domains: ["workout", "history", "progress", "persistence"] }),
    s("test/schedule.mjs"),
  ...
  entry: [
    ...
    s("test/custom-delete-editor-race.mjs"),
  ...
  workout: [
    ...
    s("test/progress-lifecycle.mjs", [], {"env": {"REPFORGE_LIFECYCLE_BROWSER": "1"}, "timeoutMs": 900000}),
    s("test/progress-recovery.mjs", [], {"timeoutMs": 900000}),
